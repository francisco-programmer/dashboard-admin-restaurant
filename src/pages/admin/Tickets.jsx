    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-y-4 mb-10">
        ...
        <div className="flex items-center gap-4">
          <button className="bg-secondary-100/50 hover:bg-secondary-100 flex items-center gap-2 py-2 px-4 rounded-lg hover:text-sky-500 transition-colors">
            <RiFilter2Fill /> Filtro
          </button>
          <button className="bg-sky-500 text-black hover:bg-sky-400 flex items-center gap-2 py-2 px-4 rounded-lg transition-colors">
            Create
          </button>
        </div>
      </div>
      ...
      <div className="bg-secondary-100 p-8 rounded-tl-lg rounded-tr-lg grid grid-cols-1 md:grid-cols-2 items-center">
        <div className="p-8">
          <h1 className="text-3xl mb-8">¿Cómo podemos ayudarle?</h1>
          <form>
      ...
      <Tab.Group>
        <div className="bg-secondary-100 p-8 rounded-bl-lg rounded-br-lg">
          <Tab.List className="flex flex-col md:flex-row md:items-center md:justify-between gap-x-2 gap-y-6 bg-secondary-900/50 py-3 px-4 rounded-lg">
            ...
            <div className="flex justify-center">
              <button className="bg-sky-500/90 text-black hover:bg-sky-500 flex items-center gap-2 py-2 px-4 rounded-lg transition-colors">
                Crear
              </button>
            </div>
          </Tab.List>
                  ...
                  <Disclosure>
                    ...
                    >
                      <Disclosure.Panel className="text-gray-500 text-sm px-8 py-2">
                       informacion de la administracion del restaurante{" "}
              ...
              <div className="bg-secondary-100 p-8 rounded-lg">
                ...
                <div>
                  <Disclosure>
                    ...
                    >
                      <Disclosure.Panel className="text-gray-500 text-sm px-8 py-2">
                        Se tendran en cuenta todas las  reclamaciones por parte de los clientes{" "}
                        <Link to="/" className="text-sky-500">
                          Ver mas 
                        </Link>
                      </Disclosure.Panel>
                ...
                <div className="bg-secondary-900 p-8 rounded-lg xl:mb-8">
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-8">
                      <RiFileTextLine className="text-4xl text-sky-500" />
                    ...
                    <div className="flex items-center gap-4 mb-8">
                      <RiDiscussLine className="text-4xl text-sky-500" />
                      <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                      <RiTwitterLine className="text-4xl text-sky-500" />
                      <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                      <RiGithubLine className="text-4xl text-sky-500" />
                      <div className="flex flex-col gap-1">
